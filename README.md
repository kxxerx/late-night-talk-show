...
전체 색감을 파스텔/솜사탕/기프트샵 느낌으로 조정했습니다.
...
`기프트샵에서 나가기`를 누르면 확인창이 표시됩니다.

```txt
정말 기프트샵에서 나가시겠습니까? 완전히 소각당하시겠습니까?
```
...
## 5. 골든 마스코트 기프트샵 기본 아이템

기존 기본 아이템 이름을 기프트샵 분위기로 바꾸고, 몇 가지 기본 선물을 추가합니다.
...
방문객 정보 페이지의 `기프트샵에서 나가기` 버튼을 누르면 검은 배경과 빨간 글씨의 커스텀 모달이 표시됩니다.
